...
<!-- fim -->
    ...
    <div class="cont-card">
        <div class="card">
            ...
            <div class="content">
                <h3>Canva</h3>
                <p>Aprenda a usar o Canva e amplie suas habilidades com nosso curso abrangente. O Canva é uma ferramenta essencial para qualquer pessoa que lida com design, desde designers gráficos até empreendedores que desejam criar conteúdo visual atraente.</p>
                <a href="#canva3">Mais Informações</a>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="content">
                <h3>Excel</h3>
                <p>Aprenda Excel e amplie suas habilidades profissionais com nosso curso abrangente. O Excel é uma ferramenta essencial para qualquer pessoa que lida com dados, desde profissionais de finanças até analistas de marketing.</p>
                <a href="#excel3">Mais Informações</a>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="content">
                <h3>Windows</h3>
                <p>Aprenda a mexer no Microsoft Windows e amplie suas habilidades em informática com nosso curso abrangente. O Windows é um sistema operacional essencial para qualquer pessoa que use computadores, desde usuários domésticos até profissionais de TI.</p>
                <a href="#windows3">Mais Informações</a>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="content">
                <h3>Nuvem</h3>
                <p>Entenda o funcionamento basico do armazenamento em nuvem com nosso curso. O armazenamento em nuvem é essencial para empresas que desejam aproveitar a flexibilidade e eficiência da tecnologia da nuvem.</p>
                <a href="#nuvem3">Mais Informações</a>
            </div>
        </div>
    </div>
</div>
